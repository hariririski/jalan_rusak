              ...
              <div class="row row-lg">
                ...
                <div class="col-lg-6 form-horizontal">
                    ...
                    <div class="form-group form-material ">
                      ...
                      <div class=" col-lg-9 col-sm-9">
                        <input type="text" class="form-control" name="nama_kjp"  value="<?php echo $data_jalan->nama_kjp?>"   placeholder="Nama Jkp" required="" >
                    ...
                    <div class="form-group form-material ">
                      ...
                      <div class=" col-lg-9 col-sm-9">
                        <input type="text" class="form-control" name="no_kjp"  value="<?php echo $data_jalan->no_kjp?>"  placeholder="No Jkp" required="" >
                      </div>
                    </div>
                    <div class="form-group form-material ">
