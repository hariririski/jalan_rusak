            ...
            <form  action="pengaduan/proses_tambah_pengaduan" method="post" enctype="multipart/form-data"   class="fv-form fv-form-bootstrap">
              ...
              <div class="row row-lg">
                ...
                <div class="form-group form-material col-lg-12 text-center padding-top-m">
                  <button type="submit" class="btn btn-warning waves-effect waves-light" >Cek Pengaduan</button>
                  <button type="submit" class="btn btn-success waves-effect waves-light" >Verfikasi Pengaduan</button>
                  <button type="submit" class="btn btn-danger waves-effect waves-light" >Pengaduan Palsu</button>
                </div>
              </div>
            </form>
          </div>
