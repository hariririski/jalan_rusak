    ...
    <div class="page-content container-fluid">
      <div class="row" data-plugin="matchHeight" data-by-row="true">
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <div class="widget" id="widgetUserList">
            <div class="widget-header cover overlay">
              <img class="cover-image height-200" src="<?php echo site_url(); ?>assets/assets//examples/images/dashboard-header.jpg"
              alt="..." />
              ...
              <ul class="list-group list-group-full list-group-dividered">
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a class="avatar avatar-lg" href="javascript:void(0)">
                        <img class="img-responsive" src="<?php echo site_url(); ?>assets/global/portraits/1.jpg" alt="...">
                      </a>
                    </div>
                ...
                <li class="list-group-item">
                  <div class="media">
                    <div class="media-left">
                      <a class="avatar avatar-lg" href="javascript:void(0)">
                        <img class="img-responsive" src="<?php echo site_url(); ?>assets/global/portraits/2.jpg" alt="...">
                      </a>
                    </div>
                    <div class="media-body">
                ...
                <li class="list-group-item">
                  <div class="media">
                    <div class="media-left">
                      <a class="avatar avatar-lg" href="javascript:void(0)">
                        <img class="img-responsive" src="<?php echo site_url(); ?>assets/global/portraits/3.jpg" alt="...">
                      </a>
                    </div>
                    <div class="media-body">
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <div class="widget widget-shadow">
            <div class="widget-header cover overlay">
              <div class="cover-background height-200" style="background-image: url('<?php echo site_url(); ?>assets/global/photos/placeholder.png')"></div>
            </div>
