...
class M_Pengaduan extends CI_Model{
    ...
    {
        $query=$this->db->query("SELECT * FROM `pengaduan` LEFT JOIN kabupaten ON kabupaten.id_kabupaten=pengaduan.id_kabupaten LEFT JOIN kecamatan ON kecamatan.id_kecamatan=pengaduan.id_kecamatan");
        return $query->result();
    }
